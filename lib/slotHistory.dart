...
class SlotHistory extends StatefulWidget {
  const SlotHistory({super.key});

  @override
  State<SlotHistory> createState() => _SlotHistoryState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Your slot bookings",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black),),
      ),
      body:  Container(
